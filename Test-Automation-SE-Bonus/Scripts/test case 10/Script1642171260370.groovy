...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Mood Administration Users Accounts Add_0e8dec/input_Address_cancel'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Mood Administration Users Accounts Add_0e8dec/input_Address_cancel'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Error/button_Continue'), 0)

WebUI.click(findTestObject('Object Repository/Page_Error/button_Continue'))
