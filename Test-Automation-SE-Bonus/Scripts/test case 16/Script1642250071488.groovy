...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Mood Add a new course/label_Course full name'), 0)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Mood Add a new course/input__cancel'), 0)

WebUI.click(findTestObject('Object Repository/Page_Mood Add a new course/input__cancel'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Mood All courses/section_Search courses                     _a46e39'))
