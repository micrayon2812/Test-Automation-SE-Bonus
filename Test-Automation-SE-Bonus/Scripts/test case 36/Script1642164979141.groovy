...
WebUI.click(findTestObject('Object Repository/Page_Moodle/a_Tran Minh Triet'))

WebUI.click(findTestObject('Object Repository/Page_Tran Minh Triet Public profile/span_Message'))

WebUI.setText(findTestObject('Object Repository/Page_Tran Minh Triet Public profile/textarea_Use enter to send_yui_3_17_2_1_164_393869'), 
    'Hello')

WebUI.click(findTestObject('Object Repository/Page_Tran Minh Triet Public profile/button__btn btn-link btn-icon icon-size-3 m_754a09'))
