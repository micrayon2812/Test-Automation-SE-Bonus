...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Mood Add a new course/h2_Add a new course'), 'Add a new course')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Mood Add a new course/div_- Missing full name'), '- Missing full name')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Mood Add a new course/div_- Missing short name'), '- Missing short name')
