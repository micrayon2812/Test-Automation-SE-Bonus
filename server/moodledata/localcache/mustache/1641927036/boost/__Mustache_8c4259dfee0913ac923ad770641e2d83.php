...
class __Mustache_8c4259dfee0913ac923ad770641e2d83 extends Mustache_Template
{
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            // 'datetimeformat' inverted section
            $value = $context->find('datetimeformat');
            if (empty($value)) {
...
';
        ...
        $buffer .= $this->sectionC01d6467a2057618058049fcfec94121($context, $indent, $value);
    ...
    private function sectionC01d6467a2057618058049fcfec94121(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
