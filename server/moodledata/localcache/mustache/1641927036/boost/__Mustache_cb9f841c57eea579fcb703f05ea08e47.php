...
class __Mustache_cb9f841c57eea579fcb703f05ea08e47 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockC9c2a09a40f43e05f4acec38dbb65d1c'),
            ));
...
';
    ...
    public function blockC9c2a09a40f43e05f4acec38dbb65d1c($context)
    {
        $indent = $buffer = '';
