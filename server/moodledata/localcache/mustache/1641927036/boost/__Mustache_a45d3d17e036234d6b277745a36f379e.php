...
class __Mustache_a45d3d17e036234d6b277745a36f379e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA2e418531b5d8efdac9b8bdfb283c524($context, $indent, $value);
...
';
            ...
            $buffer .= $this->section39dea5a925d4e701227742bedf5e08be($context, $indent, $value);
        }

        return $buffer;
    }

    private function sectionA2e418531b5d8efdac9b8bdfb283c524(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section39dea5a925d4e701227742bedf5e08be(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
