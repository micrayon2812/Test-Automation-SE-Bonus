...
class __Mustache_4ac2c1ab565030c63dca6d054eef381e extends Mustache_Template
{
...
';
        ...
        // 'disabled' section
        $value = $context->find('disabled');
        $buffer .= $this->section1ae0f6196703e566c41f329dc84b80ae($context, $indent, $value);
    ...
    private function section1ae0f6196703e566c41f329dc84b80ae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
