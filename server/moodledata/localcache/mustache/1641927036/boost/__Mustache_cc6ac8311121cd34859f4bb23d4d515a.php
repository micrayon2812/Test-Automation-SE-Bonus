...
class __Mustache_cc6ac8311121cd34859f4bb23d4d515a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block57387f217a7031c2933580333300559f'),
            ));
...
';
    ...
    public function block57387f217a7031c2933580333300559f($context)
    {
        $indent = $buffer = '';
