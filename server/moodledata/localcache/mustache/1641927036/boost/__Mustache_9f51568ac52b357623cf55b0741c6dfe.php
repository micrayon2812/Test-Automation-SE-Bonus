...
class __Mustache_9f51568ac52b357623cf55b0741c6dfe extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('mod_forum/discussion_favourite_toggle')) {
            $context->pushBlockContext(array(
                ...
                'favouritecontent' => array($this, 'block21d0646a9ae88292d9be4bcf4c870392'),
            ));
    ...
    private function section764af5de78c1ffc1e0c2fb9f437713b0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block21d0646a9ae88292d9be4bcf4c870392($context)
    {
        $indent = $buffer = '';
        // 'userstate.favourited' section
        $value = $context->findDot('userstate.favourited');
        $buffer .= $this->section764af5de78c1ffc1e0c2fb9f437713b0($context, $indent, $value);
