...
class __Mustache_8f10524bfcccd95e96f7d8760fe95b60 extends Mustache_Template
{
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_calendar/event_list')) {
            $context->pushBlockContext(array(
                'noeventsmessage' => array($this, 'blockB09fd9b66fe12c70d5197bdf79e9caf1'),
            ));
...
';
    ...
    public function blockB09fd9b66fe12c70d5197bdf79e9caf1($context)
    {
        $indent = $buffer = '';
        $buffer .= '            ';
        // 'str' section
