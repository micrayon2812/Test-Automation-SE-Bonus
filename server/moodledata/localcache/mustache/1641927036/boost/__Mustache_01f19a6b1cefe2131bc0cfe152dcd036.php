...
class __Mustache_01f19a6b1cefe2131bc0cfe152dcd036 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="form-filesize defaultsnext">
';
...
';
        ...
        $buffer .= $this->section6087026caaf8f496c321b7c55a2fca7b($context, $indent, $value);
        $buffer .= '</label>
';
...
';
    ...
    private function section6087026caaf8f496c321b7c55a2fca7b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'filesizeunits, admin';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
