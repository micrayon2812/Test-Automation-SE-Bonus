...
class __Mustache_93591daf8f82d0916234dcace1c44629 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section04482a117527316e9847df4738e928e3($context, $indent, $value);
    ...
    private function section02f31ef892adee3d159e0a1e22cc0633(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionCa379fd8e28d1df2dde2af34d1cbee79(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section04482a117527316e9847df4738e928e3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section02f31ef892adee3d159e0a1e22cc0633($context, $indent, $value);
...
';
                // 'userstate.subscribed' section
                $value = $context->findDot('userstate.subscribed');
                $buffer .= $this->sectionCa379fd8e28d1df2dde2af34d1cbee79($context, $indent, $value);
                // 'userstate.subscribed' inverted section
                $value = $context->findDot('userstate.subscribed');
                if (empty($value)) {
