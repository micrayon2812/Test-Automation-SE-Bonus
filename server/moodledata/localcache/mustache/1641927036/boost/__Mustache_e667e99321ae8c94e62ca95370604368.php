...
class __Mustache_e667e99321ae8c94e62ca95370604368 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block200b4aee1f06dda6ba485c46c3931474'),
            ));
...
';
    ...
    public function block200b4aee1f06dda6ba485c46c3931474($context)
    {
        $indent = $buffer = '';
        // 'element.frozen' inverted section
        $value = $context->findDot('element.frozen');
