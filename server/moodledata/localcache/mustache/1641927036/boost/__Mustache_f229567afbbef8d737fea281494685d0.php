...
class __Mustache_f229567afbbef8d737fea281494685d0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2ab4ce981709d81f2a6566accb2857f7($context, $indent, $value);
...
';
        // 'locked' section
        $value = $context->find('locked');
        $buffer .= $this->section3a43a03b40ce888712ebbdb9423dc1ab($context, $indent, $value);
        // 'locked' inverted section
        $value = $context->find('locked');
        if (empty($value)) {
...
';
    ...
    private function section2ab4ce981709d81f2a6566accb2857f7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section3a43a03b40ce888712ebbdb9423dc1ab(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
