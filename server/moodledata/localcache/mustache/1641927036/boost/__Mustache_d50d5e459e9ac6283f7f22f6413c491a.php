...
class __Mustache_d50d5e459e9ac6283f7f22f6413c491a extends Mustache_Template
{
...
';
        ...
        // 'hidden' section
        $value = $context->find('hidden');
        $buffer .= $this->sectionA9564eab03372e33a62a3632ed20828e($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</a>
';
    ...
    private function sectionA9564eab03372e33a62a3632ed20828e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
