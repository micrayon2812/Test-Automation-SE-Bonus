...
class __Mustache_f7fff4ad5a5fd04719076fc2a489af6a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockE9616f1277a98d64632f57d4f4aa7a97'),
            ));
...
';
    ...
    private function sectionF2e6df14a0498a5372b0adf249f6e39e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE65e5eba1aceb7b6e47afdc8f0955182(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionF2e6df14a0498a5372b0adf249f6e39e($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    public function blockE9616f1277a98d64632f57d4f4aa7a97($context)
    {
        $indent = $buffer = '';
        // 'element.frozen' inverted section
        $value = $context->findDot('element.frozen');
...
';
        ...
        $value = $context->findDot('element.frozen');
        $buffer .= $this->sectionE65e5eba1aceb7b6e47afdc8f0955182($context, $indent, $value);
