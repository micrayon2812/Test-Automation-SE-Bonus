...
class __Mustache_4af44787b0bb2cfab9fcb69bc8a4d25a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section745095d840bacb8e2cbf6426184cb314($context, $indent, $value);
        $buffer .= $indent . '        </select>
';
        // 'showbutton' section
        $value = $context->find('showbutton');
        $buffer .= $this->section15b417d836e5a55a6d0975cd3a32b404($context, $indent, $value);
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section14a6ab5bbf8cc35d5899a4f9b096ad9c($context, $indent, $value);
        }
...
';
    ...
    private function section4723f524e8bb3369242a4173dfede852(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionDd7a4d3ae2389bfb5077be1a9fa051d9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                // 'options' section
                $value = $context->find('options');
                $buffer .= $this->section4723f524e8bb3369242a4173dfede852($context, $indent, $value);
...
';
    ...
    private function section745095d840bacb8e2cbf6426184cb314(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionDd7a4d3ae2389bfb5077be1a9fa051d9($context, $indent, $value);
...
';
    ...
    private function section15b417d836e5a55a6d0975cd3a32b404(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section14a6ab5bbf8cc35d5899a4f9b096ad9c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
